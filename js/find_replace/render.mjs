...
.pix-fr-tog:hover { border-color: var(--red-acc,#d9830b); color: #ddd; }
.pix-fr-tog.on { background: var(--red-acc,#d9830b); border-color: var(--red-acc,#d9830b); color: #fff; }
...
.pix-fr-row.is-drop-target-above { box-shadow: 0 -2px 0 0 var(--red-acc,#d9830b); }
.pix-fr-row.is-drop-target-below { box-shadow: 0 2px 0 0 var(--red-acc,#d9830b); }
...
.pix-fr-toggle.on { background: var(--red-acc,#d9830b); border-color: var(--red-acc,#d9830b); color: #fff; }
...
.pix-fr-field:focus { border-color: var(--red-acc,#d9830b); }
...
.pix-fr-arrow { color: var(--red-acc,#d9830b); font-weight: 700; line-height: 30px; flex: none; }
...
.pix-fr-delete:hover { color: var(--red-acc,#d9830b); background: color-mix(in srgb, var(--red-acc,#d9830b) 12%, transparent); }
...
.pix-fr-add { color: var(--red-acc,#d9830b); border-color: color-mix(in srgb, var(--red-acc,#d9830b) 50%, transparent); }
.pix-fr-add:hover { background: var(--red-acc,#d9830b); border-color: var(--red-acc,#d9830b); color: #fff; }
.pix-fr-reset:hover { background: var(--red-acc,#d9830b); border-color: var(--red-acc,#d9830b); color: #fff; }
...
.pix-fr-confirm-btn.primary { background: var(--red-acc,#d9830b); border-color: var(--red-acc,#d9830b); color: #fff; }
  ...
  sections: [
    {
      ...
      body:
        "Drop this node between any STRING-producing text source and the node that uses the text. It applies your find/replace rules top to bottom and passes the edited result on. The before/after box on the node previews the last text that ran through.",
    },
    {
      heading: "How to use",
      bullets: [
...
registerNodeHelp("ReaperFindReplace", FR_HELP);
