// Inline label editor for Any Switch Advanced (Reaper) rows.
//
...
export function openLabelEditor(node, slotIdx /* 1-based */, rect) {
  ...
  input.style.cssText = [
    ...
    "background: #1f1f1f",
    "color: #d8d8d8",
    `border: ${borderPx}px solid var(--red-acc,#f66744)`,
    "border-radius: 3px",
    `padding: 0 ${padX}px`,
  ...
  // (CLAUDE.md Note Reaper Pattern #5 / Load Image Reaper Pattern #6)
