// ╔═══════════════════════════════════════════════════════════════╗
// ║  SetNode (Reaper) / GetNode (Reaper) - cross-graph scope helpers               ║
// ╚═══════════════════════════════════════════════════════════════╝
//
// PRIVATE NAMESPACE: every helper here scans ONLY ReaperSetNode /
// ReaperGetNode. It never touches any other pack's Set/Get-style nodes, so
...
// frontend 1.47.10+, so subgraph flattening at submission "just works".

export const SET_TYPE = "ReaperSetNode";
export const GET_TYPE = "ReaperGetNode";
