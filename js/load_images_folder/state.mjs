// Load Images from Folder Reaper — shared state helpers.
// Imported by both index.js and ui.mjs (no circular import on index.js).

export const COMFY_CLASS = "ReaperLoadImagesFolder";
...
export const DEFAULT_STATE = {
  ...
  // "sub_cat", so Save Image Reaper can rebuild the same folder tree
  keepFolders: false,
  sort: "name", // "name" | "date"
