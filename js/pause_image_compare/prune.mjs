// Pause Image Reaper - prompt-prune helpers (pure, ComfyUI-free).
//
...
export function applyGateMode(
  ...
  if (mode === "pause") {
    ...
    const gateSrc = isLink(entry.inputs[imageInput])
      ? [String(entry.inputs[imageInput][0]), Number(entry.inputs[imageInput][1])]
      : null;

    delete entry.inputs[imageInput];
