// LoRA Loader Reaper - shared state + helpers (imported by every module here).
//
...
export const DEFAULT_PREFS = {
  ...
  accent: null,       // highlight color; null = the Reaper orange
...
// color pick or a settings toggle would change the node's cache signature and
...
export function accentOf(node) {
  ...
  return (d && d.accent) || globalAccent() || BRAND;   // then the master Reaper default
}
