// Load Image (Reaper) - shared state + accent. Kept tiny and separate from
...
export const CLASS = "ReaperLoadImage";
export const STATE_PROP = "loadImagePixState";       // reuse Load Image's key (see above)
export const HIDDEN_INPUT = "LoadImageMiniState";    // matches nodes/node_load_image.py
export const ACCENT_SETTING = "Reaper.LoadImage.AccentColor";
