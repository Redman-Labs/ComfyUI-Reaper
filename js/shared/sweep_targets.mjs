// Sweepable-target registry - lets a Reaper node advertise parameters that live in
// a serialized STATE BLOB instead of in LiteGraph widgets, so XY Plot Reaper can
...
// widget to enumerate - LoRA Loader Reaper saw exactly that and never appeared in
...
//
//   registerSweepProvider("ReaperLoraLoader", {
