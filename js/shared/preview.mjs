// ╔═══════════════════════════════════════════════════════════════╗
// ║  Reaper Shared — Node Preview System                          ║
// ║  Consistent preview display for all Reaper nodes              ║
// ╚═══════════════════════════════════════════════════════════════╝

import { createDummyWidget } from "./utils.mjs";
import { redApiUrl } from "./api_url.mjs";
...
export function restoreNodePreview(parts, json, node) {
  try {
    ...
    const url = redApiUrl(`/view?filename=${encodeURIComponent(fn)}&type=input&subfolder=reaper&t=${Date.now()}`);
