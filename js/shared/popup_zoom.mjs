...
// graph while a fixed 12px popup reads tiny beside it. Dropdown Reaper solved
...
//
// NOT for floating SETTINGS panels (.rl-ddp, the Sizes / Sliders / Run Timer
